            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col text-end">
                        <a href="{{route('paginainicialdohomem')}}" class="btn btn-outline-danger">
                ...
                <form action="{{route('newNoteSubmit')}}" method="post">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control bg-primary text-white" name="text_note" rows="5">{{old('text_title')}}</textarea>
                                @error('text_note')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col text-end">
                            <a href="{{route('paginainicialdohomem')}}" class="btn btn-primary px-5"><i class="fa-solid fa-ban me-2"></i>Cancel</a>
